...
NBuildings = {
	ANTI_AIR_SUPERIORITY_MULT = 80.0,	-- How much air superiority reduction to the enemy does our AA guns? Normally each building level = -1 reduction. With this multiplier.
	...
	RADAR_RANGE_MAX = 250,				-- Range is interpolated between building levels 1-15.
...
NAir = {
	...
	NAVAL_COMBAT_EXTERNAL_PLANES_JOIN_RATIO = 0.15,		-- Max planes that can join a combat comparing to the total strength of the ships
	...
	CAS_NIGHT_ATTACK_FACTOR = 0.8,                      -- CAS damaged get multiplied by this in land combats at night
...
NNavy = {
	...
	DETECTION_SUBS_CHANCE_BALANCE = 30.0,						-- Same as above, but for sub detection. It should be very hard to detect just the subs.
	...
	SUBMARINE_REVEAL_BASE_CHANCE = 0.002,							-- Base chance for submarine detection. It's modified by the difference of a spootter's submarines detection vs submarine visibility. Use this variable for game balancing.
...
NAI = {
	...
	UPGRADE_XP_RUSH_UPDATE = 450,				-- If XP is above this on the daily tick the AI will attempt to spend it
